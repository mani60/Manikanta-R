...
import { SiFacebook, SiGithub, SiLinkedin, SiReaddotcv } from 'react-icons/si';
      ...
      <div className="hero">
        <div className="container">
          <h1 className="hero__heading">
            ...
            <span className="hero__name">Manikanta</span>
          </h1>
          ...
          <div className="hero__social">
            ...
            <div className="hero__social__text">
              <ul>
                ...
                <li>
                  <a
                    href="https://www.facebook.com/marri.manikanta"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <SiFacebook />
